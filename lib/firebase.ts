 ...
 *
 * NOTE: `ignoreUndefinedProperties` is essential — optional fields such as a
 * goal's `current`/`target` are `undefined` until set, and Firestore rejects
 * undefined values outright, which would fail every write.
 */
